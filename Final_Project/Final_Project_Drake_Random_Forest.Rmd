---
title: "Final_Project_Drake_Random_Forest"
...
```{r}
ggplot(final_rap, aes(x=speechiness, y=popularity)) + geom_point() + geom_smooth(method="lm", formula=y~x, se=T) + labs(title = "Song Popularity by 'Speechiness'") 

ggplot(final_rap, aes(x=reorder(key,popularity, FUN=median), y=popularity)) + geom_boxplot() + labs(title = "Song Popularity by 'Key'", xlab = "key") 
```
