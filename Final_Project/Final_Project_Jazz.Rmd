...
```{r}
ggplot(final_rap, aes(x=instrumentalness, y=popularity)) + geom_point(alpha=.1) + geom_smooth(method="lm", formula=y~x, se=T) + labs(title = "Song Popularity by 'Instrumentalness'") 
```
