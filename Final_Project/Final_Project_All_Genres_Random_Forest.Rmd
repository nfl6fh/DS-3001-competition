...
View(as.data.frame(varImp(pop_RF, type = 2, scale = TRUE))) #type 1 is error on oob, 
...
sqrt(pop_RF$mse[length(pop_RF$mse)])
sqrt(pop_RF_2$mse[length(pop_RF_2$mse)])
...
View(as.data.frame(pop_test_RF$predicted))
