...
### Our preliminary goal was to create a model that had a NMRSE below 0.05. While we were ultimately unable to accomplish that goal, we have a few ideas for next steps
